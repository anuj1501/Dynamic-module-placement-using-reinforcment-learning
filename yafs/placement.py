        ...
        for item in self.data["initialAllocation"]:
            if app_name == item["app"]:
                ...
                idDES = sim.deploy_module(
                    app_name, module, services[module], [idtopo])
    ...
    def initial_allocation(self, sim, app_name):
        ...
        for item in self.data["initialAllocation"]:
            if app_name == item["app"]:
                ...
                services = app.services
                idDES = sim.deploy_module(
                    app_name, module, services[module], [self.idCloud])
    ...
    def initial_allocation(self, sim, app_name):
        ...
        for module in services.keys():
            if "Coordinator" == module:
                ...
                idDES = sim.deploy_module(
                    app_name, module, services[module], id_mobiles)
    ...
    def initial_allocation(self, sim, app_name):
        ...
        for module in services.keys():
            ...
            if "Coordinator" == module:
                ...
                idDES = sim.deploy_module(
                    app_name, module, services[module], id_proxies)
            elif "Client" == module:
                idDES = sim.deploy_module(
                    app_name, module, services[module], id_mobiles)
...
# class DynamicPlacement(Placement):

#     # override the initial allocation function
#     def initial_allocation(self,sim,app_name,number_of_cycles_required, message_size):
